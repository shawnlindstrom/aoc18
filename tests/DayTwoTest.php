...
class DayTwoTest extends TestCase
{
    ...
    {
        $result = (new DayTwo())->__invoke('./data/day2testinput.txt');
    ...
    {
        $result = (new DayTwo())->__invoke('./data/day2input.txt');
    ...
    {
        $result = (new DayTwoPartTwo())->__invoke('./data/day2part2testinput.txt');
    ...
    {
        $result = (new DayTwoPartTwo())->__invoke('./data/day2input.txt');
